...
class BankAccount{
    ...
    // 1度に引き落とせる額を計算します。所有額の20%を最大で引き落とせる額とします。
...
function withdrawPage(bankAccount){
    ...
    nextBtn.addEventListener("click", function(){
        ...
        // コンソールで引き出せる額を確認します。
        // 最初の口座情報、withdrawページで引き下ろす額を変更してコンソールで結果を確認してみましょう。
        console.log(bankAccount.calculateWithdrawAmount(billSummation(billInputs, "data-bill")));
